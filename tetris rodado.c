...
int main()
{
    int pontuacao = 0, linha = 1, coluna = 1, novaLinha, novaColuna, rotacoes = 0;
    ...
    for(int valorAleatorio = Aleatorio(pontuacao); TRUE; valorAleatorio = Aleatorio(pontuacao), linha = 1, coluna = 1, rotacoes = 0){
        while(1){
            for (int k = 1; k <= 2; k++)
